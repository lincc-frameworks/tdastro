...
class PeriodicSource(SEDModel, ABC):
    ...
    Parameterized values include:
      * dec - The object's declination in degrees. [from BaseSEDModel]
      * distance - The object's luminosity distance in pc. [from BaseSEDModel]
      * period - The period of the source, in days.
      * ra - The object's right ascension in degrees. [from BaseSEDModel]
      * redshift - The object's redshift. [from BaseSEDModel]
      * t0 - The t0 of the zero phase, date. [from BaseSEDModel]
