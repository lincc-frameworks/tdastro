...
def test_snia_end2end(oversampled_observations, passbands_dir):
    ...
    res_list, passbands = run_snia_end2end(
        oversampled_observations, passbands_dir, solid_angle=solid_angle, nsample=None
    )
    ...
    num_samples = 1
    res_list, passbands = run_snia_end2end(
        oversampled_observations, passbands_dir, solid_angle=solid_angle, nsample=num_samples
    )
